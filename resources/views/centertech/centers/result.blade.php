...
<div class="card">
  ...
  <div class="card-body"> 
      ...
      {{ Form::model($bloodbag,[ 'method'=>'post','action'=>['DonorsController@resultstore',$center->centre_id,$centertech->employee_id]] ) }}
        ...
        {{Form::hidden('taken_at_id',$bloodbag->centre_id)}}
        ...
        {{Form::hidden('hosp_centre','centre')}}
