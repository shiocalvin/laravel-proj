...
<div class="card">
  ...
  <div class="card-body"> 
      ...
      @include('partials.success')
        ...
        {{ Form::model($hospitaltech,[ 'method'=>'patch','action'=>['HospitalLabController@update',$hospitaltech->techs_id]]) }}
        ...
        <div class="form-group row">
            ...
            {{Form::text('nida',$hospitaltech->techs_nida,['class'=>'form-control','placeholder'=>'Enter Nida id' ])}}
        ...
        <div class="form-group row">
            ...
            {{Form::select('gender',array('male'=>'male','female'=>'female'),$hospitaltech->sex,['class'=>'form-control' ])}}
        </div>

        <div class="form-group row">
            {{Form::label('Dateofbirth','Date of Birth:')}}
            {{Form::date('date_of_birth',$hospitaltech->dob,['class'=>'form-control'])}}
        </div>
        ...
        <div class="form-group row float-right">
        {{Form::submit('Edit Hospital lab technician',['class'=>'btn text-white float-right','style'=>'background-color:#8b0000'])}}
