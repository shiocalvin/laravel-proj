...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-sm-4 col-md-4">
      <!-- small box -->
      <div class="small-box text-white" style="background-color: purple">
        <div class="inner">
         <h3>{{$directors}}</h3>

          <p>Center Directors</p>
        </div>
        <div class="icon">
          <i class="ion ion-"></i>
        </div>
  ...
  <div class="col-lg-4 col-sm-4 col-md-4">
    <!-- small box -->
    <div class="small-box text-white" style="background-color: olive">
      <div class="inner">
       <h3>{{$bloodrequests}}</h3>
...
<div class="col-lg-4 col-sm-4 col-md-4">
  <!-- small box -->
  <div class="small-box text-white" style="background-color: peru">
    <div class="inner">
     <h3>{{$corrupted}}</h3>
