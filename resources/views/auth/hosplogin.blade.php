...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white" style="background-color: darkred">HOSPITAL LOGIN</div>
                ...
                <form method="POST" action="{{ route('hospital.login.submit')}}">
                        ...
                        <div class="form-group row">
                            <label for="station" class="col-md-4 col-form-label text-md-right">Hospital id </label>
                        ...
                        <input type="hidden" value="hosplab" name="position">
