...
<div class="card">
  ...
  <div class="card-body"> 
      ...
      @include('partials.success')
        ...
        {{ Form::open([ 'method'=>'post','action'=>'CenterDirectorController@store'])}}
        ...
        {{Form::submit('Create Center Director',['class'=>'btn text-white float-right','style'=>'background-color:#8b0000'])}}
