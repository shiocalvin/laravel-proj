...
<div class="card">
  ...
  <div class="card-body"> 
      ...
      @include('partials.success')
        ...
        {{ Form::model($centerdirector,[ 'method'=>'patch','action'=>['CenterDirectorController@update',$centerdirector->employee_id]]) }}
        ...
        <div class="form-group row">
            ...
            {{Form::text('nida',$centerdirector->employees_nida,['class'=>'form-control','placeholder'=>'Enter Nida id' ])}}
        ...
        <div class="form-group row">
            ...
            {{Form::select('gender',array('male'=>'male','female'=>'female'),$centerdirector->sex,['class'=>'form-control' ])}}
        </div>

        <div class="form-group row">
            {{Form::label('Dateofbirth','Date of Birth:')}}
            {{Form::date('date_of_birth',$centerdirector->dob,['class'=>'form-control'])}}
        </div>
        ...
        {{Form::hidden('position','nbtsdir')}}

        
        

        <div class="form-group row float-right">
        {{Form::submit('Edit Center Director',['class'=>'btn text-white float-right','style'=>'background-color:#8b0000'])}}
