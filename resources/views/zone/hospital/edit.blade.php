  ...
  <div class="card-body"> 
      ...
      {{-- <form action="{{ route("center.store") }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            {{Form::select('region_id',$regionsoptions,$hospital->region,['class'=>'form-control region' ])}}
        </div>

        <div class="form-group row">
            {{Form::label('District','District:')}}
            {{Form::select('district_id',$districtsoptions,$hospital->district,['class'=>'form-control' ])}}
        </div>

        <div class="form-group row">
            {{Form::label('Ward','Ward:')}}
            {{Form::select('ward_id',$wardsoptions,$hospital->ward,['class'=>'form-control' ])}}
        </div>
