...
<div class="row">
    ...
    <div class="col-lg-4 col-sm-4 col-md-4">
        ...
        <div class="small-box text-white" style="background-color: darkred">
         ...
         <a href="{{route('zone.index')}}" class="small-box-footer"> <i class="fas fa"></i></a>
        </div>
    </div>
...
<div class="row">
  ...
  <div class="col-lg-4 col-sm-4 col-md-4">
    <!-- small box -->
    <div class="small-box text-white" style ="background-color: indianred">
      <div class="inner">
        <h3>{{$donors}}</h3>
...
<div class="col-lg-4 col-sm-4 col-md-4">
  <!-- small box -->
  <div class="small-box text-white" style="background-color: lightseagreen">
    <div class="inner">
      <h3>{{$bloodbags}}</h3>
...
<div class="col-lg-4 col-sm-4 col-md-4">
  <!-- small box -->
  <div class="small-box text-white" style="background-color: darkmagenta">
    <div class="inner">
      <h3>{{$employees}}</h3>

      <p>Total NBTS Employees</p>
    </div>
    <div class="icon">
      <i class="ion ion-"></i>
    </div>
