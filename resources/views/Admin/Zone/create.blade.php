...
<div class="card">
  ...
  <div class="card-header text-white" style="background-color: darkred" ><strong>New Zone Director</strong></div> 
  <div class="card-body"> 
      @include('partials.errors')

        {{ Form::open([ 'method'=>'post','action'=>'AdminZoneController@store'])}}
        ...
        {{Form::submit('Create Zone Director',['class'=>'btn text-white float-right','style'=>'background-color:#8b0000'])}}
