    ...
    <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="small-box bg-secondary">
          ...
          <h3>{{$receivedbags}}</h3>
            ...
            <p>Blood bags waiting for confirmation</p>
          </div>
          <div class="icon">
            <i class="ion ion"></i>
          </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4">
        ...
        <div class="small-box bg-success">
          ...
          <h3>{{$techs}}</h3>
            ...
            <p>Hospital laboratory technicians</p>
          </div>
          <div class="icon">
            <i class="ion ion-"></i>
          </div>
...
<div class="row">
  ...
  <div class="col-lg-4 col-sm-4 col-md-4">
    <!-- small box -->
    <div class="small-box text-white" style="background-color: sienna">
      <div class="inner">
       <h3>{{$untested}}</h3>

        <p>Untested blood bags</p>
      </div>
      <div class="icon">
        <i class="ion ion-"></i>
      </div>
